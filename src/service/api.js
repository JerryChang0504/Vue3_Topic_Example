...
const api = {
  ...
  // 刪除商品(註記刪除)
  deleteProducts: () => apiService.put(API_ROUTES.PRODUCT_DELETE),
  //選項列表
  optionsList: () => apiService.get(API_ROUTES.OPTION_LIST),
  //新增選項
  optionsAdd: (data) => apiService.post(API_ROUTES.OPTION_ADD),
}
